...
export const EN: Record<string, string> = {
  ...
  "음별은 음악 감상을 기록하고 나누는 서비스입니다.": "UmByul is a service for logging and sharing what you listen to.",
  ...
  "저장됐어요": "Saved",
  "좋아하는 장르 (선택) — 추천에 반영돼요.": "Genres you like (optional) — used for recommendations.",
  ...
  "서비스 소개": "About",
  후원하기: "Donate",
  "음별은 한 사람이 운영하는 서비스입니다. 서버 운영 비용(호스팅·스토리지)에 커피 한 잔이 큰 힘이 됩니다.": "UmByul is run by one person. A cup of coffee toward server costs (hosting & storage) means a lot.",
  ...
  "후원 창구는 곧 열립니다.": "Donations open soon.",
  "결제·환불은 외부 후원 플랫폼에서 안전하게 처리됩니다.": "Payments and refunds are handled securely by an external platform.",
  공지사항: "Announcements",
  패치노트: "Patch notes",
  "페이지 이동": "Pagination",
  릴리스: "Releases",
  ...
  "관리자에 의해 삭제되었습니다.": "Removed by an admin.",
  ...
  "일시 정지되어 평가할 수 없습니다.": "You're temporarily suspended and can't rate.",
  "계정이 정지되어 평가할 수 없습니다.": "Your account is suspended, so you can't rate.",
  "시행일": "Effective date",
  ...
  "음별에서 평가하고 리뷰하세요.": "Rate and review on UmByul.",
  ...
  화제순: "Hot",
  "좋아요 많은 순": "Most liked",
  "좋아요 비율 높은 순": "Highest like ratio",
  보기: "View",
  카드형: "Card",
  축약형: "Compact",
  "정렬 기준": "Sort by",
  ...
  보내기: "Send",
  "보내는 중…": "Sending…",
  "문의가 접수되었습니다.": "Your message has been sent.",
  "답변은 입력하신 이메일로 보내드립니다.": "We'll reply to the email you provided.",
  "이메일 형식을 확인하세요.": "Please enter a valid email address.",
  "제목을 입력하세요.": "Please enter a title.",
  "내용을 입력하세요.": "Please enter your message.",
  "불러오는 중…": "Loading…",
  "모두 확인했어요": "You're all caught up",
  "본문으로 건너뛰기": "Skip to content",
  "확인을 위해 사용자명을 입력하세요": "Enter your username to confirm",
  "기본 정보": "Basic info",
  "생년월일을 확인하세요.": "Please check your date of birth.",
  "국가": "Country",
  "국가·성별": "Country & gender",
  "이 정보는 다음 날짜 이후 다시 변경할 수 있습니다.": "You can change this again after",
  "약관이 업데이트되었습니다": "Our terms have been updated",
  "계속하려면 변경된 내용을 확인하고 동의해주세요.": "Please review the changes and agree to continue.",
  "위 내용을 확인했으며 동의합니다": "I have read and agree to the above",
  "동의하고 계속": "Agree and continue",
  "동의 처리 중 문제가 발생했습니다. 다시 시도해주세요.": "Something went wrong while saving your consent. Please try again.",
  ...
  "평가를 삭제하면 경험치 10 XP가 차감돼요. 삭제할까요?": "Deleting this rating removes the 10 XP you earned. Delete it?",
  ...
  "부적절한 리뷰는 신고 없이도 관리자가 삭제하고 제재할 수 있습니다.":
    "Admins may remove inappropriate reviews and take action against the author, even without a report.",
  삭제: "Delete",
  취소: "Cancel",
  "저장 중…": "Saving…",
  수정: "Update",
  ...
  "리뷰 신고": "Report review",
  "유저 신고": "Report user",
  "신고 내용은 운영자가 검토합니다.": "Reports are reviewed by our admins.",
  ...
  "확인 중…": "Checking…",
  "사용 가능": "Available",
  "올바른 이메일 형식이 아닙니다.": "Please enter a valid email address.",
  ...
  "믹스 만들기": "Create a mix",
  "믹스 제목": "Mix title",
  "한마디 (선택) — 이거 들어봐": "A note (optional) — listen to this",
  ...
  "믹스 수정": "Edit mix",
  목록으로: "Back to list",
  발견으로: "Back to Discover",
  "믹스 신고": "Report mix",
  안내: "Help",
  저장됨: "Saved",
  "순서는 화살표로 바꿀 수 있어요.": "Reorder with the arrows.",
  "곡을 검색해 담기만 하면, 유튜브 링크가 있는 곡은 스포티파이 없이도 들을 수 있어요.": "Just search and add tracks — songs that have a YouTube link can be played even without Spotify.",
  "아래로 이동": "Move down",
  공유: "Share",
  복사됨: "Copied",
...
const JA: Record<string, string> = {
  ...
  "음별은 음악 감상을 기록하고 나누는 서비스입니다.": "UmByulは音楽の記録を残し、共有するサービスです。",
  ...
  "저장됐어요": "保存しました",
  "좋아하는 장르 (선택) — 추천에 반영돼요.": "好きなジャンル（任意）— おすすめに反映されます。",
  "로그인 / 가입": "ログイン / 登録",
  홈: "ホーム",
  ...
  "서비스 소개": "サービス紹介",
  후원하기: "支援する",
  "음별은 한 사람이 운영하는 서비스입니다. 서버 운영 비용(호스팅·스토리지)에 커피 한 잔이 큰 힘이 됩니다.": "UmByulは一人で運営しています。サーバー費（ホスティング・ストレージ）へのコーヒー一杯が大きな支えになります。",
  "순수 후원이라 어떤 대가나 혜택도 없어요. 부담 갖지 마시고, 마음이 있으실 때만.": "純粋な支援で、見返りや特典はありません。無理せず、お気持ちのある時だけどうぞ。",
  "Ko-fi에서 후원하기": "Ko-fiで支援する",
  "후원 창구는 곧 열립니다.": "支援の受付は近日開始します。",
  "결제·환불은 외부 후원 플랫폼에서 안전하게 처리됩니다.": "決済・返金は外部の支援プラットフォームが安全に処理します。",
  공지사항: "お知らせ",
  패치노트: "パッチノート",
  "페이지 이동": "ページ移動",
  릴리스: "リリース",
  ...
  "리뷰 {count}": "レビュー{count}件",
  "다음 레벨까지 {xp} XP": "次のレベルまで {xp} XP",
  ...
  "무엇을 할 수 있나요": "できること",
  "음별에서 평가하고 리뷰하세요.": "UmByul で評価してレビューしよう。",
  ...
  "모두 확인했어요": "すべて表示しました",
  "본문으로 건너뛰기": "本文へスキップ",
  "확인을 위해 사용자명을 입력하세요": "確認のためユーザー名を入力してください",
  "기본 정보": "基本情報",
  "생년월일을 확인하세요.": "生年月日を確認してください。",
  "국가": "国",
  "국가·성별": "国・性別",
  "이 정보는 다음 날짜 이후 다시 변경할 수 있습니다.": "この情報は次の日付以降に再変更できます:",
  "약관이 업데이트되었습니다": "規約が更新されました",
  "계속하려면 변경된 내용을 확인하고 동의해주세요.": "続けるには、変更内容をご確認のうえ同意してください。",
  "위 내용을 확인했으며 동의합니다": "上記の内容を確認し、同意します",
  "동의하고 계속": "同意して続ける",
  "동의 처리 중 문제가 발생했습니다. 다시 시도해주세요.": "同意の保存中に問題が発生しました。もう一度お試しください。",
  "비밀번호 표시": "パスワードを表示",
  "비밀번호 숨기기": "パスワードを隠す",
  ...
  "Spotify에서 듣기": "Spotifyで聴く",
  마감까지: "終了まで",
  "YouTube에서 보기": "YouTubeで見る",
  트랙리스트: "トラックリスト",
  정보: "情報",
  "{count}곡": "{count} 曲",
  발매일: "リリース日",
  ...
  "평가를 삭제하면 경험치 10 XP가 차감돼요. 삭제할까요?": "評価を削除すると獲得した経験値10 XPが差し引かれます。削除しますか？",
  "욕설·비방은 금지됩니다. 비판은 좋지만 비난은 안 됩니다.":
  ...
  "6자리 코드": "6桁のコード",
  확인: "確認",
  "메일이 안 보이면 스팸함을 확인하세요.": "メールが見つからない場合は迷惑メールフォルダを確認してください。",
  "가입을 환영합니다": "新規登録",
  "확인 중…": "確認中…",
  "사용 가능": "利用可能",
  ...
  "이메일 변경": "メール変更",
  "새 이메일로 확인 메일을 보냈습니다. 링크를 눌러야 변경이 완료됩니다.":
    "新しいメールに確認メールを送信しました。リンクを開くと変更が完了します。",
  "변경하려면 새 이메일로 온 확인 링크를 눌러야 합니다.":
  ...
  "이 페이지에서 멘션 알림 끄기": "このページのメンションをミュート",
  "이 페이지의 멘션 알림이 꺼져 있습니다": "このページのメンションはミュート中",
  믹스: "ミックス",
  "믹스 만들기": "ミックスを作る",
  "믹스 제목": "ミックスのタイトル",
  ...
  안내: "ヘルプ",
  저장됨: "保存しました",
  "순서는 화살표로 바꿀 수 있어요.": "矢印で並べ替えられます。",
  "곡을 검색해 담기만 하면, 유튜브 링크가 있는 곡은 스포티파이 없이도 들을 수 있어요.": "曲を検索して追加するだけで、YouTubeリンクがある曲はSpotifyがなくても聴けます。",
  "아래로 이동": "下へ",
  공유: "共有",
  복사됨: "コピーしました",
...
const ES: Record<string, string> = {
  ...
  "음별은 음악 감상을 기록하고 나누는 서비스입니다.": "UmByul es un servicio para registrar y compartir lo que escuchas.",
  ...
  "저장됐어요": "Guardado",
  "좋아하는 장르 (선택) — 추천에 반영돼요.": "Géneros que te gustan (opcional) — se usan para recomendaciones.",
  "로그인 / 가입": "Iniciar sesión / Registrarse",
  홈: "Inicio",
  ...
  "서비스 소개": "Acerca de",
  후원하기: "Apóyanos",
  "음별은 한 사람이 운영하는 서비스입니다. 서버 운영 비용(호스팅·스토리지)에 커피 한 잔이 큰 힘이 됩니다.": "UmByul lo lleva una sola persona. Un café para los costos de servidor (hosting y almacenamiento) ayuda mucho.",
  "순수 후원이라 어떤 대가나 혜택도 없어요. 부담 갖지 마시고, 마음이 있으실 때만.": "Es una donación pura, sin recompensas ni ventajas. Sin presión, solo si quieres.",
  "Ko-fi에서 후원하기": "Apoyar en Ko-fi",
  "후원 창구는 곧 열립니다.": "Las donaciones se abrirán pronto.",
  "결제·환불은 외부 후원 플랫폼에서 안전하게 처리됩니다.": "Los pagos y reembolsos los gestiona de forma segura una plataforma externa.",
  공지사항: "Anuncios",
  패치노트: "Notas de versión",
  "페이지 이동": "Paginación",
  릴리스: "Lanzamientos",
  "작업 중": "En progreso",
  "현재 버전": "Versión actual",
  ...
  "{until}까지 이용이 정지되어 작성이 제한됩니다.": "Tu cuenta está suspendida hasta {until}; no puedes publicar.",
  "사유": "Motivo",
  "경고를 받았습니다.": "Has recibido una advertencia.",
  "새 공지사항이 등록되었어요.": "Se publicó un nuevo anuncio.",
  "일시 정지되어 평가할 수 없습니다.": "Tu cuenta está suspendida temporalmente y no puedes calificar.",
  ...
  "음별에서 평가하고 리뷰하세요.": "Califica y reseña en UmByul.",
  ...
  "리뷰어 랭킹": "Ranking de reseñadores",
  화제순: "En tendencia",
  "좋아요 많은 순": "Más me gusta",
  "좋아요 비율 높은 순": "Mayor proporción de me gusta",
  보기: "Ver",
  카드형: "Tarjetas",
  축약형: "Compacta",
  "정렬 기준": "Ordenar por",
  ...
  "제목을 입력하세요.": "Escribe un asunto.",
  "내용을 입력하세요.": "Escribe tu mensaje.",
  "불러오는 중…": "Cargando…",
  "모두 확인했어요": "Estás al día",
  "본문으로 건너뛰기": "Saltar al contenido",
  "확인을 위해 사용자명을 입력하세요": "Escribe tu nombre de usuario para confirmar",
  "기본 정보": "Información básica",
  "생년월일을 확인하세요.": "Verifica tu fecha de nacimiento.",
  "국가": "País",
  "국가·성별": "País y género",
  "이 정보는 다음 날짜 이후 다시 변경할 수 있습니다.": "Podrás volver a cambiarlo después de",
  "약관이 업데이트되었습니다": "Hemos actualizado nuestros términos",
  "계속하려면 변경된 내용을 확인하고 동의해주세요.": "Revisa los cambios y acéptalos para continuar.",
  "위 내용을 확인했으며 동의합니다": "He leído y acepto lo anterior",
  "동의하고 계속": "Aceptar y continuar",
  "동의 처리 중 문제가 발생했습니다. 다시 시도해주세요.": "Ocurrió un problema al guardar tu consentimiento. Inténtalo de nuevo.",
  ...
  "평가를 삭제하면 경험치 10 XP가 차감돼요. 삭제할까요?": "Al eliminar la calificación se descuentan los 10 XP obtenidos. ¿Eliminar?",
  "욕설·비방은 금지됩니다. 비판은 좋지만 비난은 안 됩니다.":
  ...
  "피드에서 숨겼어요": "Se ocultó de tu feed",
  "실행 취소": "Deshacer",
  더보기: "Más",
  차단: "Bloquear",
  "차단 해제": "Desbloquear",
  ...
  "님이 회원님의 리뷰를 좋아합니다": " le dio me gusta a tu reseña",
  ...
  "jpg, png, webp · 최대 5MB": "jpg, png, webp · hasta 5 MB",
  닉네임: "Apodo",
  변경: "Guardar",
  ...
  발견으로: "Volver a Descubrir",
  "믹스 신고": "Reportar mix",
  안내: "Ayuda",
  저장됨: "Guardado",
  "순서는 화살표로 바꿀 수 있어요.": "Reordena con las flechas.",
  "곡을 검색해 담기만 하면, 유튜브 링크가 있는 곡은 스포티파이 없이도 들을 수 있어요.": "Solo busca y añade pistas: las canciones con enlace de YouTube se pueden reproducir aunque no tengas Spotify.",
  "아래로 이동": "Bajar",
  공유: "Compartir",
  복사됨: "Copiado",
