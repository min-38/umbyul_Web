...
const JA: Record<string, string> = {
  ...
  "서비스 소개": "サービス紹介",
  후원하기: "支援する",
  "Glitter는 한 사람이 운영하는 서비스입니다. 서버비(호스팅·스토리지)에 커피 한 잔이 큰 힘이 됩니다.": "Glitterは一人で運営しています。サーバー費（ホスティング・ストレージ）へのコーヒー一杯が大きな支えになります。",
...
const ES: Record<string, string> = {
  ...
  "서비스 소개": "Acerca de",
  후원하기: "Apóyanos",
  "Glitter는 한 사람이 운영하는 서비스입니다. 서버비(호스팅·스토리지)에 커피 한 잔이 큰 힘이 됩니다.": "Glitter lo lleva una sola persona. Un café para los costos de servidor (hosting y almacenamiento) ayuda mucho.",
