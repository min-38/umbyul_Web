...
export const EN: Record<string, string> = {
  ...
  "평가가 더 쌓이면 시세가 표시됩니다.": "The trend appears once more ratings accumulate.",
...
const JA: Record<string, string> = {
  ...
  "평가가 더 쌓이면 시세가 표시됩니다.": "評価が増えると推移が表示されます。",
...
const ES: Record<string, string> = {
  ...
  "평점 시세": "Tendencia de calificación",
  시세: "Tendencia",
  "(수정됨)": "(editado)",
  "이 댓글을 삭제할까요?": "¿Eliminar este comentario?",
  "평가가 더 쌓이면 시세가 표시됩니다.": "La tendencia aparece cuando se acumulan más calificaciones.",
