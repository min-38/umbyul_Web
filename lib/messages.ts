...
const KO: Record<string, string> = {
  ...
  DEMOGRAPHICS_COOLDOWN: "국가·성별은 자주 변경할 수 없습니다. 잠시 후 다시 시도해주세요.",
...
const EN: Record<string, string> = {
  ...
  DEMOGRAPHICS_COOLDOWN: "Country and gender can't be changed frequently. Please try again later.",
...
const JA: Record<string, string> = {
  ...
  DEMOGRAPHICS_COOLDOWN: "国・性別は頻繁に変更できません。しばらくしてからお試しください。",
...
const ES: Record<string, string> = {
  ...
  DEMOGRAPHICS_COOLDOWN: "El país y el género no se pueden cambiar con frecuencia. Inténtalo más tarde.",
