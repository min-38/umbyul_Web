...
const EN: Record<string, string> = {
  ...
  DEMOGRAPHICS_COOLDOWN: "You can't change your basic info this often. Please try again later.",
...
const ES: Record<string, string> = {
  ...
  INVALID_SCORE: "La calificación debe estar entre 0,5 y 5,0 en pasos de media estrella.",
  INVALID_TARGET: "Elemento no válido.",
