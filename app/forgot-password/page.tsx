      ...
      <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950">
        {sent ? (
          <div className="flex flex-col items-center gap-3 text-center">
            <BrandMark />
            <p className="font-medium text-black dark:text-zinc-50">재설정 링크를 보냈습니다</p>
            <p className="text-sm text-zinc-500">
              <span className="text-zinc-700 dark:text-zinc-300">{email}</span> 의 메일함을 확인해주세요.
            </p>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col items-center gap-3">
              <BrandMark />
              <h1 className="text-lg font-medium text-black dark:text-zinc-50">비밀번호 재설정</h1>
              <p className="text-center text-sm text-zinc-500">가입한 이메일로 재설정 링크를 보내드립니다.</p>
            </div>
